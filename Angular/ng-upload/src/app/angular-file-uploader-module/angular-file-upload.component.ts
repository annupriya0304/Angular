import {
  ...
  export class AngularFileUploaderComponent implements OnChanges {
    ...
    afterUpload = false;
    uploadStarted = false;
    uploadMsgText: string | undefined;
    uploadMsgClass: string | undefined;
    ...
    ngOnChanges(changes: SimpleChanges) {
      ...
      if (changes.config && this.config) {
        ...
        this.responseType = this.config.uploadAPI.responseType || undefined;
    ...
    onChange(event: any) {
      ...
      for (let i = 0; i < fileList.length; i++) {
        const currentFileExt ="" // Get file extension.
